...
describe('tile', function () {
    ...
    describe('when tiling an image that is 1024x1024 pixels', function () {
        it('should not produce a bogus -1 zoom image', function (done) {
            ...
            // .then(()=>expectImagesToBeTheSame(tempDir + '/tile_2_2_2.png', 'spec/expected/1024/tile_2_2_2.png')) // Fails in travis
            // .then(()=>expectImagesToBeTheSame(tempDir + '/tile_2_3_2.png', 'spec/expected/1024/tile_2_3_2.png')) // Fails in travis
